...
{
	$DATA_ARRAY = unserialize($_SESSION['CCExitGraph_DATA_ARRAY_SERIALIZED'], ['allowed_classes' => false]);
}
else
{
...
{
	$LABEL_ARRAY = unserialize($_SESSION['CCExitGraph_LABEL_ARRAY_SERIALIZED'], ['allowed_classes' => false]);
}
else
{
	http_response_code(400);
